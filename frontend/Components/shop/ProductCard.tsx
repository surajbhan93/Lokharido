...
export default function ProductCard({ image, brand, name, price, originalPrice, discount, rating }: ProductCardProps) {
    return (
        <div className="w-full cursor-pointer group border hover:border-yellow-500 rounded-sm bg-zinc-50 p-1 flex flex-col rounded-t-xl">
            {/* Image Section */}
            ...
            <div>
                ...
                <h2 className="text-sm font-medium text-slate-900 line-clamp-1 mb-1 group-hover:text-yellow-600">{name}</h2>
